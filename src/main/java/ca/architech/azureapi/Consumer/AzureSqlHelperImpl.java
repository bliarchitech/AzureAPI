...
public class AzureSqlHelperImpl implements AzureSqlHelper {

    private static final Logger logger = Logger.getLogger(AzureSqlHelperImpl.class.getName());

    @Override
    public void createTable(Connection connection, String azureDBName) {
        try {
    ...
    @Override
    public void dropTable(Connection connection, String azureDBName) {
        try {
            StringBuilder sqlBuilder = new StringBuilder();
    ...
    @Override
    public void insertData(Connection connection, String azureDBName, List<Temperature> list) {
        if (list.size() == 0) {
    ...
    @Override
    public void getAllData(Connection connection, String azureDBName) {
    ...
    @Override
    public void getData(Connection connection, String azureDBName, Double xVal, Double yVal) {
        ResultSet resultSet = null;
    ...
    @Override
    public void updateData(Connection connection, String azureDBName, Double updatedVal, Double xVal, Double yVal) {
        try {
            StringBuilder sqlBuilder = new StringBuilder();
    ...
    @Override
    public void deleteData(Connection connection, String azureDBName, Double xVal, Double yVal) {
        try {
            StringBuilder sqlBuilder = new StringBuilder();
    ...
    @Override
    public void deleteAllData(Connection connection, String azureDBName) {
        try {
            StringBuilder sqlBuilder = new StringBuilder();
            sqlBuilder.append("DELETE FROM ");
            sqlBuilder.append(azureDBName);
